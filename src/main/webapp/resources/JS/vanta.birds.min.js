!function (e, t) {
    ...
    e.r(t), e.d(t, {default: () => P}), Number.prototype.clamp = function (e, t) {
    ...
    r.VantaBase = class {
        constructor(e = {}) {
            ...
            if (this.options = Object.assign({
                ...
                scale: 1,
                scaleMobile: 1
            }, t), (e instanceof HTMLElement || "string" == typeof e) && (e = {el: e}), Object.assign(this.options, e), this.options.THREE && (s = this.options.THREE), this.el = this.options.el, null == this.el) a('Instance needs "el" param!'); else if (!(this.options.el instanceof HTMLElement)) {
                const e = this.el;
        ...
        initThree() {
            s.WebGLRenderer ? (this.renderer = new s.WebGLRenderer({
                alpha: !0,
                antialias: !0
            }), this.el.appendChild(this.renderer.domElement), this.applyCanvasStyles(this.renderer.domElement), isNaN(this.options.backgroundAlpha) && (this.options.backgroundAlpha = 0), this.scene = new s.Scene) : console.warn("[VANTA] No THREE defined on window")
        }
    ...
    class E extends l {
        ...
        initGpgpuBirds() {
            const e = (e => {
                ...
                const i = 3 * S, n = 3 * i, o = new T.BufferAttribute(new Float32Array(3 * n), 3),
                ...
                const u = {};
                for (l = 0; l < 3 * i; l++) {
                    const t = ~~(l / 3), i = t % z / z, n = ~~(t / z) / z, o = ~~(l / 9) / S, h = o.toString(),
        ...
        getNewCol(e) {
            const t = this.options, i = null != t.color1 ? t.color1 : 4456448,
                n = null != t.color2 ? t.color2 : 6684672, o = new T.Color(i), s = new T.Color(n);
            let r, a;
            if (a = -1 != t.colorMode.indexOf("Gradient") ? Math.random() : e, 0 == t.colorMode.indexOf("variance")) {
                const e = (o.r + Math.random() * s.r).clamp(0, 1), t = (o.g + Math.random() * s.g).clamp(0, 1),
        ...
        onInit() {
            ...
            if (M) try {
                ...
                for (var s = 0; s < l; s++) {
                    ...
                    const h = -1 != i.colorMode.indexOf("Gradient"), c = V(i), d = c.attributes.position.length,
